import { IVzlaCity } from "../types/locations";

export const VENEZUELA_CITIES: IVzlaCity[] = [
  // AMAZONAS
  { id: "puerto_ayacucho", name: "Puerto Ayacucho", stateId: "amazonas" },
  ...
  { id: "puerto_la_cruz", name: "Puerto La Cruz", stateId: "anzoategui" },
  { id: "lecheria", name: "Lechería", stateId: "anzoategui" },
  ...
  { id: "guasdualito", name: "Guasdualito", stateId: "apure" },
  ...
  { id: "turmero", name: "Turmero", stateId: "aragua" },
  { id: "la_victoria", name: "La Victoria", stateId: "aragua" },
  ...
  { id: "barinitas", name: "Barinitas", stateId: "barinas" },
  ...
  { id: "puerto_ordaz", name: "Puerto Ordaz", stateId: "bolivar" },
  { id: "san_felix", name: "San Félix", stateId: "bolivar" },
  ...
  { id: "punto_fijo", name: "Punto Fijo", stateId: "falcon" },
  ...
  { id: "calabozo", name: "Calabozo", stateId: "guarico" },
  ...
  { id: "cabudare", name: "Cabudare", stateId: "lara" },
  ...
  { id: "ejido", name: "Ejido", stateId: "merida" },
  ...
  { id: "petare", name: "Petare", stateId: "miranda" },
  { id: "guarenas", name: "Guarenas", stateId: "miranda" },
  ...
  { id: "acarigua", name: "Acarigua", stateId: "portuguesa" },
  ...
  { id: "carupano", name: "Carúpano", stateId: "sucre" },
  ...
  { id: "tariba", name: "Táriba", stateId: "tachira" },
  ...
  { id: "valera", name: "Valera", stateId: "trujillo" },
  ...
  { id: "catia_la_mar", name: "Catia La Mar", stateId: "la_guaira" },
...
export const getCitiesByState = (state: string): IVzlaCity[] =>{
  return VENEZUELA_CITIES.filter( city => city.stateId === state);
}