...
// Tremor Drawer [v1.0.0] (adaptado a shadcn Button + cn)
...
const focusRing =
  "focus:outline-none focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:ring-[3px]";
    ...
    <DrawerPortal>
      <DrawerOverlay>
        <DrawerPrimitives.Content
          ...
          className={cn(
            // base
            "fixed inset-y-2 z-50 mx-auto flex w-[95vw] flex-1 flex-col overflow-y-auto rounded-md border p-4 shadow-lg max-sm:inset-x-2 sm:inset-y-2 sm:right-2 sm:max-w-lg sm:p-6",
            // border color
            "border-border",
            // background color
            "bg-background",
  ...
  return (
    ...
    >
      ...
      <DrawerPrimitives.Close asChild>
        <Button
          variant="ghost"
          className="aspect-square p-1 hover:bg-muted"
          aria-label="Cerrar"
        >
